...
const file_orderpb_order_proto_rawDesc = "" +
	...
	"customerID\x18\x02 \x01(\tR\n" +
	"customerID\x12#\n" +
	"\x05items\x18\x03 \x03(\v2\r.orderpb.ItemR\x05items\x12\x16\n" +
	...
	"\apriceID\x18\x04 \x01(\tR\apriceID\"F\n" +
	"\x10ItemWithQuantity\x12\x16\n" +
	"\x06itemID\x18\x01 \x01(\tR\x06itemID\x12\x1a\n" +
	"\bquantity\x18\x02 \x01(\x05R\bquantity2\xbf\x01\n" +
	"\fOrderService\x12B\n" +
	...
	"\vUpdateOrder\x12\x0e.orderpb.Order\x1a\x16.google.protobuf.EmptyB;Z9github.com/phara/mallive/internal/common/genproto/orderpbb\x06proto3"
